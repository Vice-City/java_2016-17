...
/**
 * Simple program which instantiates an ObjectMultistack object
 * and uses it to push a couple of ValueWrapper objects wrapping
 * Integers and Double objects. It then prints the result of
 * various addition operations.
 * 
 * @author Vice Ivušić
 *
 */
