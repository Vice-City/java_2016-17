 ...
 * integer value.
 * 
 * <p>Also offers methods for observers to register and unregister
...
public class IntegerStorage {
	...
	public void addObserver(IntegerStorageObserver observer) {
		...
		/*
		 * In case a new observer is added while the subject is notifying
		 * its existing observers; subject still has old references.
		 */
	...
	public void removeObserver(IntegerStorageObserver observer) {
		...
		/*
		 * In case an observer is removed while the subject is notifying
		 * its existing observers; subject still has old references.
		 */
		observers = new ArrayList<>(observers);
