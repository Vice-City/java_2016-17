...
public class ScriptDemo {
	...
	public static void main(String[] args) {
		String documentBody = DemoUtilities.readFromDisk("webroot/scripts/osnovni.smscr");
