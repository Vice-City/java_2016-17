...
/**
 * Simple program which loads and executes the script zbrajanje.smscr,
 * and prints out the results to standard output.
 * Expects the script to be stored (relative root folder) in 
 * {@code webroot/scripts/zbrajanje.smscr}.
 * 
 * @author Vice Ivušić
 *
 */
public class ScriptDemo2 {
	...
	public static void main(String[] args) {
		String documentBody = DemoUtilities.readFromDisk("webroot/scripts/zbrajanje.smscr");
