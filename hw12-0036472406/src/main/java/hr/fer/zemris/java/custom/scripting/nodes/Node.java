...
public abstract class Node {
	...
	/**
	 * Expects an INodeVisitor object to be passed on. This method will
	 * call the visitor's appropriate handling method, depending on the
	 * node upon which accept was called.
	 * 
	 * @param visitor an INodeVisitor object
	 */
