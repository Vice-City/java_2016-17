...
public class QuantumDouble {
	 ...
	 */
	public QuantumDouble applyBinaryFunction(QuantumDouble operand, 
	 ...
	 * 		   if the result of the operation is undefined for the specified operand
	 */
	public QuantumDouble applyUnaryFunction(Function<Double, Double> operator) {
		if (operator == null) {
			throw new IllegalArgumentException("Specified operator must not be null!");
		}
		
		double result = operator.apply(quantumValue);
